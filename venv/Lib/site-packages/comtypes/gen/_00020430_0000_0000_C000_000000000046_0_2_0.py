...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_PIXELS', 'Gray', 'OLE_TRISTATE', 'FONTITALIC',
           'IFontDisp', 'VgaColor', 'OLE_XPOS_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'FONTUNDERSCORE', 'Monochrome',
           'IPicture', 'Color', 'Unchecked', 'FONTNAME', 'Picture',
           'OLE_YSIZE_CONTAINER', 'FontEvents', 'Checked',
           'IFontEventsDisp', 'OLE_COLOR', 'OLE_OPTEXCLUSIVE',
           'FONTBOLD', 'OLE_XPOS_HIMETRIC', 'LoadPictureConstants',
           'StdFont', 'Font', 'OLE_YPOS_PIXELS', 'OLE_XPOS_PIXELS',
           'OLE_XSIZE_CONTAINER', 'StdPicture',
           'OLE_ENABLEDEFAULTBOOL', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_CONTAINER', 'IFont', 'OLE_YPOS_HIMETRIC',
           'OLE_CANCELBOOL', 'FONTSIZE', 'Default', 'IPictureDisp',
           'OLE_YSIZE_PIXELS', 'OLE_HANDLE', 'OLE_XSIZE_HIMETRIC']
